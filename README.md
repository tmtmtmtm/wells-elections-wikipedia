...
One unlinked Independent (now fixed), one Motherworld Party which
already exists in Wikidata (Q75340426), plus one new one to create
using `create-new-party.js`

Birthday Party -> Q98544775
...
"By-election, 21 November 1855"

* "1855 Wells by-election" -> Q98544780
...
Then sent to QuickStatements as https://editgroups.toolforge.org/b/QSv2T/1598026380094/
